...
export class MenuService {
  ...
  public createVerticalMenuItem(menu: Array<Menu>, menuItem) {
    ...
    this.renderer2.setAttribute(img, 'src', '../../../../assets/images/' + menuItem.icon);
    this.renderer2.setAttribute(img, 'style', 'height: 22px;width:22px ');
    this.renderer2.appendChild(link, img);
    ...
    setTimeout(()=>{
      if(this.router.url === menuItem.routerLink){
        this.setActiveLink(menu, link);
    }
    },500)
    return div;
  ...
  public createHorizontalMenuItem(menu: Array<Menu>, menuItem) {
    ...
    let span = this.renderer2.createElement('span');
    this.renderer2.addClass(span, 'menu-title');
    this.renderer2.setAttribute(span, "i18n", "@@Title");
    this.renderer2.appendChild(link, span);
    let menuText = this.renderer2.createText(menuItem.title);
    this.renderer2.appendChild(span, menuText);
      ...
      menu.forEach((menuItem) => {
        ...
        if (activeLink) {
          if (activeLink.id === link.id) {
            activeLink.querySelector('img').src = '../../../../assets/images/' + menuItem.iconActive
          }
          else {
            activeLink.querySelector('img').src = '../../../../assets/images/' + menuItem.icon
          }
