...
@Component({
  selector: 'app-patient-height-chart',
  templateUrl: './patient-height-chart.component.html',
  styleUrls: ['./patient-height-chart.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PatientHeightChartComponent implements OnInit {
  chartValue: any;
  @Input() graphdata;
  @Input() graphtype;
  LineChart = [];
  ...
  createChart1() {
    $(() => {
    this.LineChart1 = new Chart('heightChart1', {
      type: 'line',
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Height chart with 0 to 36 months percentile data'
        },
        scales: {
          xAxes: [{
            scaleLabel: {
  ...
  createChart2() {
    $(() => {
    this.LineChart2 = new Chart('heightChart2', {
      type: 'line',
      plugins: [this.plugin1, this.axisPlugin],
      data: {
        datasets: this.value
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Height chart with 2 to 20 years percentile data'
        },
        scales: {
          xAxes: [{
            scaleLabel: {
  ...
  saveChart(chartName) {
    ...
    windowContent += '<html>'
    windowContent += '<head><title>Patient Height Chart</title></head>';
    windowContent += '<body>'
